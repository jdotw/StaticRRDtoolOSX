...
PATH="/Developer/usr/bin:/Developer/usr/sbin:$PATH:$STAGE/bin"
CFLAGS="-mmacosx-version-min=10.6 -isysroot /Developer/SDKs/MacOSX10.6.sdk -Wl,-search_paths_first -O -arch i386 -I$STAGE/include"
